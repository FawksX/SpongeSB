...
public class Statements {
  ...
  public static final String CREATE_ISLAND_PERMISSIONS_TABLE = "CREATE TABLE IF NOT EXISTS spongysb_island_permissions (island_uuid VARCHAR(36) NOT NULL PRIMARY KEY, " +
          ...
          "invite text NOT NULL, kick text NOT NULL, deposit text NOT NULL, withdraw text NOT NULL, warp text NOT NULL, view_upgrades text NOT NULL, set_upgrades text NOT NULL, promote text NOT NULL," +
  ...
  public static final String SAVE_ISLAND_PERMISSIONS = "REPLACE INTO spongysb_island_permissions (island_uuid, place, break, entry, spawner_place, spawner_break, door, button, lever, gate, container, armorstand, pressure_plate, name, view_perms, set_perms, invite, kick, deposit, withdraw, warp, view_upgrades, set_upgrades, promote, demote, ban, home, is_lock, set_home, item_drop, item_pickup, hurt_animals, hurt_mobs, spawn_eggs, breed, ender_pearl, music, animals, send_out_pokemon) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
